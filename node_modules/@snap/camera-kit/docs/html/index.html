...
<p><em>Note that if using <a href="functions/createUserMediaSource.html" class="tsd-kind-function">createUserMediaSource</a>, best performance can be achieved by requesting the resolution you want to display. This can be done using <a href="https://developer.mozilla.org/en-US/docs/Web/API/MediaDevices/getUserMedia#parameters">constraints</a></em></p>

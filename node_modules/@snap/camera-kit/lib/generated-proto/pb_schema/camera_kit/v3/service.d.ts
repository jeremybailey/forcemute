...
export interface GetGroupRequest {
    /** Group ID */
    id: string;
    /** Optional device or user data that can be used by ranking to provide lenses. */
...
export interface GetInitializationConfigResponse {
    /**
     * Flag to specify whether customer chose opt-in or opt-out
     * to collect IDFV identifiers on SDK side
     */
    appVendorUuidOptIn: boolean;
    /**
     * Defines if lens watermark must be rendered on top of the lenses. Watermark will be shown for Staging versions
     * of SnapKit applications. The goal is to force CameraKit users to promote their applications to Production
...
export declare const GetGroupLensResponse: {
        ...
        lens?: ({
            ...
            content?: ({
                ...
                preview?: ({
                    ...
                    imageUrl?: string | undefined;
                } & Record<Exclude<keyof I["lens"]["content"]["preview"], "imageUrl">, never>) | undefined;
                assetManifest?: ({
                    type?: import("./lens").LensAssetManifestItem_Type | undefined;
                    id?: string | undefined;
                    requestTiming?: import("./lens").LensAssetManifestItem_RequestTiming | undefined;
    ...
    } & Record<Exclude<keyof I, "lens">, never>>(object: I): GetGroupLensResponse;
};
...
export interface Metrics {
    ...
    /** GetInitializationConfig returns SDK session specific config values */

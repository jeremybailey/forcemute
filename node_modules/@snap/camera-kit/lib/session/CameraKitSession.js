    ...
    setSource(source, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield cameraKitSource.attach(this.lensCore, (error) => {
                logger.error(cameraKitSourceError("Error happened during source attachment.", error));
            });
            ...
            if (this.source) {
                try {
                    yield this.source.detach((error) => {
                        logger.error(cameraKitSourceError("Error happened during source detachment.", error));
                    });
                    ...
                    logger.error(cameraKitSourceError(`Detaching prior source of type ${typeof this.source} failed.`, error));
                }
            }
        });
    }
